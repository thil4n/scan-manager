package com.wso2.vms.product.service;
...
public class ProductService {
    ...
    private final com.wso2.vms.buisnessunit.BuisnessUnitRepository buisnessUnitRepository;

    public ProductService(ProductRepository productRepository, com.wso2.vms.buisnessunit.BuisnessUnitRepository buisnessUnitRepository) {
    ...
    public ProductResponseDto create(CreateProductDto dto) {
        ...
        com.wso2.vms.buisnessunit.BuisnessUnit bu = buisnessUnitRepository.findById(dto.getBusinessUnitId())
